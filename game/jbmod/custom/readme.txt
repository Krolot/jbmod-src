...
For example, you might have the following file structure:
	...
	jbmod/custom/my_custom_stuff/   <<< This subfolder will be added as a search custom
	jbmod/custom/my_custom_stuff/models/custom_model.mdl
	jbmod/custom/my_custom_stuff/materials/custom_material.vmt
	jbmod/custom/my_custom_stuff/materials/vgui/custom_ui_thing.res
	jbmod/custom/some_mod.vpk       <<< This VPK will be added as a search custom
	jbmod/custom/another_mod.vpk    <<< This VPK will be added as a search custom
...
Note that the following directory structure is NOT correct:
	...
	jbmod/custom/models/my_model.mdl

That will add the directory "jbmod/custom/models" as a search path, in which case the
